...
import { featuredUpdateSchema, inventoryUpdateSchema, productSchema, productUpdateSchema } from '../validations/catalogValidation';
...
router.patch('/:productId/featured', requireAdmin, validateBody(featuredUpdateSchema), updateFeatured);
